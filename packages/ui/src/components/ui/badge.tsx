...
function Badge({ ref, className, variant, asChild = false, ...props }: React.ComponentProps<'span'>
  & VariantProps<typeof badgeVariants> & { asChild?: boolean } & { ref?: React.RefObject<HTMLSpanElement | null> }) {
