...
function RadioGroup({ ref, className, ...props }: React.ComponentProps<typeof RadioGroupPrimitive.Root> & { ref?: React.RefObject<React.ComponentRef<typeof RadioGroupPrimitive.Root> | null> }) {
  return (
...
function RadioGroupItem({ ref, className, ...props }: React.ComponentProps<typeof RadioGroupPrimitive.Item> & { ref?: React.RefObject<React.ComponentRef<typeof RadioGroupPrimitive.Item> | null> }) {
  return (
