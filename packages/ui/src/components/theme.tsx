...
export function ThemeProvider({
  ...
  const [theme, setTheme] = useState<Theme>(
    () => (localStorage.getItem(ensurePrefix('theme', prefix)) as Theme) || defaultTheme,
  )

  const [palette, setPalette] = useState<Palette>(
    () => (localStorage.getItem(ensurePrefix('palette', prefix)) as Palette) || defaultPalette,
  )
  ...
  const value = {
    ...
    setTheme: (theme: Theme) => {
      localStorage.setItem(ensurePrefix('theme', prefix), theme)
      setTheme(theme)
    },
    palette,
    setPalette: (palette: Palette) => {
      localStorage.setItem(ensurePrefix('palette', prefix), palette)
      setPalette(palette)
    },
  }
